import { getRepositoriesFromStore, setRepositoriesInStore } from '../store/repositories'
import { Repository } from '../../models/repository.model'
import { useState, useEffect } from 'react'

export function useGetRepositories(): { data: Repository[]; error: null; loading: boolean } {
